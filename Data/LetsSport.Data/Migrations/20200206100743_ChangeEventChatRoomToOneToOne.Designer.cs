...
namespace LetsSport.Data.Migrations
{
    ...
    [Migration("20200206100743_ChangeEventChatRoomToOneToOne")]
    partial class ChangeEventChatRoomToOneToOne
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("LetsSport.Data.Models.AddressModels.Neighborhood", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("LetsSport.Data.Models.AddressModels.State", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("LetsSport.Data.Models.ArenaModels.ArenaRentalRequest", b =>
                {
                    ...
                    b.Property<int>("SporterId")
                        .HasColumnType("int");

                    b.Property<string>("SporterId1")
                        .HasColumnType("nvarchar(450)");
            ...
            modelBuilder.Entity("LetsSport.Data.Models.Mappings.ChatRoomSporter", b =>
                {
                    b.Property<int>("ChatRoomId")
                        .HasColumnType("int");
                    ...
                    b.HasKey("ChatRoomId", "SporterId");

                    b.HasIndex("ChatRoomId1");

                    b.HasIndex("SporterId1");

                    b.ToTable("ChatRoomsSporters");
                });

            modelBuilder.Entity("LetsSport.Data.Models.Mappings.EventSporter", b =>
                {
                    b.Property<int>("EventId")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("LetsSport.Data.Models.SporterModels.Sporter", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("nvarchar(450)");
            ...
            modelBuilder.Entity("LetsSport.Data.Models.AddressModels.Address", b =>
                {
                    ...
                    b.HasOne("LetsSport.Data.Models.AddressModels.Neighborhood", "Neighborhood")
                        .WithMany("Addresses")
            ...
            modelBuilder.Entity("LetsSport.Data.Models.AddressModels.City", b =>
                {
                    ...
                    b.HasOne("LetsSport.Data.Models.AddressModels.State", "State")
                        .WithMany("Cities")
            ...
            modelBuilder.Entity("LetsSport.Data.Models.ArenaModels.ArenaRentalRequest", b =>
                {
                    ...
                    b.HasOne("LetsSport.Data.Models.SporterModels.Sporter", "Sporter")
                        .WithMany()
                        .HasForeignKey("SporterId1");
                });
            ...
            modelBuilder.Entity("LetsSport.Data.Models.EventModels.Event", b =>
                {
                    b.HasOne("LetsSport.Data.Models.SporterModels.Sporter", "Admin")
