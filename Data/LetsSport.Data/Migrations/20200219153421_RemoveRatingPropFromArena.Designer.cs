...
namespace LetsSport.Data.Migrations
{
    ...
    [Migration("20200219153421_RemoveRatingPropFromArena")]
    partial class RemoveRatingPropFromArena
    {
            ...
            modelBuilder.Entity("LetsSport.Data.Models.AddressModels.Address", b =>
                {
                    b.HasOne("LetsSport.Data.Models.ArenaModels.Arena", "Arena")
                        .WithOne("Address")
                        .HasForeignKey("LetsSport.Data.Models.AddressModels.Address", "ArenaId")
            ...
            modelBuilder.Entity("LetsSport.Data.Models.Mappings.EventUser", b =>
                {
                    ...
                    b.HasOne("LetsSport.Data.Models.UserModels.User", "User")
                        .WithMany("Events")
            ...
            modelBuilder.Entity("LetsSport.Data.Models.UserModels.User", b =>
                {
                    b.HasOne("LetsSport.Data.Models.ArenaModels.Arena", "Arena")
                        .WithOne("ArenaAdmin")
                        .HasForeignKey("LetsSport.Data.Models.UserModels.User", "ArenaId");
                });
